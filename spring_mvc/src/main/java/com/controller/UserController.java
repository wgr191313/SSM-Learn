...
public class UserController {
    ...
    @ResponseBody
    public void save21(@CookieValue(value = "JESSIONID") String jessionId) throws IOException {
    ...
    //localhost:8080/user/quick17/ran
    ...
    @ResponseBody
    public void save16(@RequestParam(value = "name",required = false,defaultValue = "yiran") String username) throws IOException {
        System.out.println(username);
    }
    ...
    public String save9() throws JsonProcessingException {
        ...
        user.setUsername("lisi");
        user.setAge(30);
        //使用json的转换工具将对象转换成为json格式字符串在返回
    ...
    @ResponseBody  //告知SpringMVC框架 不进行视图跳转 直接进行数据返回
    public String save7(){
        return "hello itcast";
    }
